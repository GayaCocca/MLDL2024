...
class CustomHopper(MujocoEnv, utils.EzPickle):
    ...
    def sample_parameters(self):
        ...
        link_mass_distributions = [
            (0.5, 1.5),  # Range for link 1 mass
            (0.5, 1.5),  # Range for link 2 mass
            (0,1.5)   # Range for link 3 mass
        ]
        
        # Sample new masses from the specified uniform distributions
        new_masses = np.array([np.random.uniform(low, high) for low, high in link_mass_distributions])
