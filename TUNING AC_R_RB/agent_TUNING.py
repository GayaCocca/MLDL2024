...
class Agent(object):
    def __init__(self, policy, gamma, device='cpu'):
    ...
    def update_policy(self, algorithm = 'Reinforce', baseline=False):
        ...
        if algorithm=='Reinforce':
            discounted_rewards = discount_rewards(rewards, self.gamma) #compute the discount rewards with the corresponding function
            if baseline:
               b = 20  
