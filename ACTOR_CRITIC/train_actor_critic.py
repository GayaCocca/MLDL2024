...
def parse_args():
    ...
    parser.add_argument('--algorithm', default='ActorCritic', choices=['Reinforce', 'ActorCritic'], help='Algorithm to use: Reinforce or ActorCritic')
...
def main():
	...
	torch.save(agent.policy.state_dict(), "model.AC")
