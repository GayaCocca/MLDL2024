...
class CustomHopperRand(MujocoEnv, utils.EzPickle):
    def __init__(self, domain=None, mass_ranges = None):
        ...
        # Define the ranges for the masses if provided
        self.mass_ranges = mass_ranges if mass_ranges is not None else [(0.5, 1.5), (0.5, 1.5), (0.5, 1.5)]
    ...
    def sample_parameters(self):
        ...
        new_masses = np.array([np.random.uniform(low, high) for low, high in self.mass_ranges])
...
"""
gym.envs.register(
        id="CustomHopperRand-v0",
        entry_point="%s:CustomHopperRand" % __name__,
        max_episode_steps=500,
)

gym.envs.register(
        id="CustomHopperRand-source-v0",
        entry_point="%s:CustomHopperRand" % __name__,
        max_episode_steps=500,
